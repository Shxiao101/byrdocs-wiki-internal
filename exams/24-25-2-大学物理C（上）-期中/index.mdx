...
<Solution>
    ...
    $$
    \overrightarrow E=-\int_{-\pi}^\pi\overrightarrow e_x\frac{A\cos\phi\sin\phi}{4\pi\varepsilon_0r}\,\mathrm d\phi-\int_{-\pi}^\pi\overrightarrow e_y\frac{A\sin{}^2\phi}{4\pi\varepsilon_0r}\,\mathrm d\phi=-\frac{A\overrightarrow e_y}{4\varepsilon_0r}
    $$
</Solution>
